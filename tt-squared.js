...
(function(){
	...
	function displayOptionsMenu() {
		...
		_log('New chat height: ' + (tt2_size.height - tt2_playing_size.height - 20));
		_log('New chat width: ' + (tt2_size.width - tt2_playing_size.width - 20));

		// fix chat sizing in TT2
		$('#tt2_chat_box').find('.chat_container').css({
			height: (tt2_size.height - tt2_playing_size.height - 20) + 'px !important',
			width: (tt2_size.width - tt2_playing_size.width - 20) + 'px !important',
			top: '0 !important',
			left: '0 !important',
